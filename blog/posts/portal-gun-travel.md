Fast travel in games usually means clicking a map marker and teleporting. Functional. Boring. I wanted something that felt like a toy.

## The Portal Gun

Inspired by Portal 2, our fast travel system gives students a portal gun — a device that shoots two linked portals. Place an orange portal at the library entrance. Place a blue portal at your dorm. Walk through orange, emerge at blue. Walk through blue, emerge at orange.
...
I could have built a teleporter menu. Click a building name, appear at the building. Faster. Simpler.

But the portal gun is a *toy*. You shoot it. It makes a sound. An oval appears on the ground. You walk through it and the camera warps and you're somewhere else. The *experience* of using it is fun, not just the *outcome*.

In learning environments, fun creates usage. A teleport menu would be used when necessary. A portal gun is used for the joy of it — and along the way, students discover parts of campus they'd otherwise never visit, because someone placed a portal there.
