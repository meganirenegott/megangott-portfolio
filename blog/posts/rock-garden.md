...
In game design, there's a concept called **negative space** — areas that exist specifically to have *less* than their surroundings. Negative space isn't empty; it's deliberately quiet. It's the pause in a sentence. The rest between notes.
...
The Rock Garden asks nothing. And that's its function.

Students who need a moment — after a hard debugging session, during a break between classes, in the middle of a frustrating build — can walk to the Rock Garden and just exist. The rocks don't change. The sand doesn't shift. The desert spring reflects the sky. It's the campus equivalent of stepping outside to breathe.
...
- 🪿 **Goose** — You waddle 20% faster than normal, but you honk involuntarily every 15–45 seconds and leave droppings behind you. Other students can hear the honking. You have no control over it.
...
The transformation is stored in the database — it's not a client-side visual trick. Every player sees your goose. Reload the page: still a goose. Switch devices: goose. The curse persists until your next scheduled class begins, because even Baba Yaga respects the curriculum.

The whole system is designed to make punishment *theatrical*. Getting a timeout is something you endure. Getting turned into a goose by a witch is something you tell people about.
...
Here's where the Rock Garden's negative space gets complicated.
...
The conditions are intentionally narrow: you have to be transformed into a rock (which requires annoying Baba Yaga), you have to get to the Rock Garden (which is hard because rocks can't move — you need a friend to portal you or you need to get cursed while already standing nearby), and you have to stay cursed long enough to trigger it. It's a three-way intersection of systems that were never designed to interact.
...
## Why secrets matter more than features

The rock concert has exactly zero educational value. It exists in a space designed for quiet contemplation. It only triggers under a deeply specific condition. By every product metric, it is a waste of engineering time.

It's also one of the most-shared moments on campus.

Students who discover it screenshot it, tell their friends, and — critically — start *intentionally getting themselves cursed by Baba Yaga* just to trigger it. A punishment system that students actively seek out is a punishment system that's working. The rock concert turned a consequence into a quest.

And this is the deeper lesson about the Rock Garden: **negative space isn't the absence of content. It's the presence of potential.** A quiet room can stay quiet — and that's valuable. But a quiet room that *might* erupt into a disco if the right conditions are met? That's a space with secrets. And spaces with secrets are spaces people return to.

The Rock Garden gets visited more consistently than some of our most feature-rich buildings. Some students come for the quiet. Some come hoping to trigger the concert. Both groups are getting exactly what they need from the same room.

That's what happens when you let a campus have secrets.
